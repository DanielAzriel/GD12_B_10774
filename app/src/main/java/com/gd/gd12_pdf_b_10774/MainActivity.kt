package com.gd.gd12_pdf_b_10774
...
import com.gd.gd12_pdf_b_10774.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.dabel)
